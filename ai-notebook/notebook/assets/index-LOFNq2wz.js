...
var API_BASE = "http://localhost:3000/api/chatgpt";
function App() {
	...
	async function loadQuestions() {
		...
		const data = await (await fetch(`${API_BASE}/questions?${params.toString()}`)).json();
		setQuestions(data);
		if (!selectedId && data.length > 0) setSelectedId(data[0].id);
	}
	async function loadDetail(id) {
		setDetail(await (await fetch(`${API_BASE}/questions/${id}`)).json());
	}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "AI Notebook" }),
				...
				questions.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: item.question }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: new Date(item.capturedAt).toLocaleString() })
					]
				}, item.id))
			]
			...
			children: [!detail && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "질문을 선택하세요." }), detail?.messages.map((message) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: {
					marginBottom: 16,
					padding: 16,
					border: "1px solid #ddd",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: message.role === "user" ? "User" : "ChatGPT" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
//# sourceMappingURL=index-LOFNq2wz.js.map